...
\begin{figure}[htp]
\centering
\includegraphics[width=.7\textwidth]{results/3a65a961_payments_vs_imbalance_onesat_random.pdf}
\label{fig:onesat_random}
\end{figure}

\begin{figure}[htp]
\centering
\includegraphics[width=.7\textwidth]{results/3a65a961_payments_vs_imbalance_micro_random.pdf}
\label{fig:micro_random}
\end{figure}

\begin{figure}[htp]
\centering
\includegraphics[width=.7\textwidth]{results/3a65a961_payments_vs_imbalance_normal_random.pdf}
